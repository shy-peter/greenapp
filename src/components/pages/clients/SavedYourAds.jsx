  ...
  return (
    <div className="container mx-auto p-2 md:pt-2 ">
      {/* <div className=" container    mx-auto  flex hidden justify-between ">
        ...
        <span className=" hidden lg:hidden"><ProfileTab/></span>
      </div> */}

      <div className="  flex flex-col gap-4">
        <div className="flex justify-between gap-5">
          <p className="font-semibold text-sm lg:text-base  ">Potential Clients who saved your ads</p>
          <div>
